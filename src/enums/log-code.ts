export const enum LogCode {
    ...
    NOTIFY_IS_NOT_CORRECT = 'NOTIFY_IS_NOT_CORRECT__ERROR',
    REFUND_IS_EXIST = 'REFUND_IS_EXIST__ERROR',
    REFUND_IS_NOT_CREATED = 'REFUND_IS_NOT_CREATE__ERROR',
}
...
export const enum LogCodeId {
    ...
    NOTIFY_IS_NOT_CORRECT = 10000011,
    REFUND_IS_EXIST = 10000012,
    REFUND_IS_NOT_CREATED = 10000013,
}
